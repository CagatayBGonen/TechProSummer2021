...
public class C04_Scope01 {
	// 1- main method'un disinda olusturulan variable'lara class level variable
	// denir
	...
	// 2- static olarak tanimlanan variable'lar class icinde her yerden
	// kullanilabilir
	...
	public static void main(String[] args) {
		...
		// method1(); // main method static klubune uye, bu klube uye olmayanlari
		// muhatap almaz
		method2();
