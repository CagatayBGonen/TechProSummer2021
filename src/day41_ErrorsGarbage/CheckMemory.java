...
public class CheckMemory {
    public static void main(String[] args) {
        ...
        System.out.println("Total Memory:"+rt.totalMemory()); // makine hafiza kapasitesi
        System.out.println("Loop tan once Free Memory:"+rt.freeMemory()); // makine hafiza free alan
